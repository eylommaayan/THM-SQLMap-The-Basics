...
## 🚩 דגשים לחדר ב-TryHackMe

* **קריאת עזרה:** רוב התשובות למשימות הראשונות נמצאות בפלט של הפקודה `sqlmap -hh`.
* **זיהוי הפרמטר:** בדרך כלל בחדרים האלה, החולשה נמצאת בכתובת ה-URL אחרי ה-`?`
*
* .
*
...
הנה התרגום המלא והמדריך המפורט למשימה, ללא קיצורים, מותאם עבור המאגר שלך ב-GitHub.
